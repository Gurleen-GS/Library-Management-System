...
public class IssueBookDetails extends javax.swing.JFrame {
    ...
    public void setIssueBookDetailsToTable()
    {
        try
        {
            ...
            ResultSet rs=st.executeQuery("select * from issue_book_details where status= '"+"pendoing"+"'");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 20, 300, 100));
        ...
        jPanel1.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 120, 320, 10));
        ...
        setSize(new java.awt.Dimension(1411, 701));
